...
const webhook = new WebhookClient({
  channel: {
    url: 'https://oda-d82066176fb34dcf9d5725e608361a89-da12.data.digitalassistant.oci.oraclecloud.com/connectors/v2/listeners/webhook/channels/11e75a87-cef2-4be1-a113-323cb0b5dd4d',
    secret: 'smJmNl7NliCble5u9lOGM76J10O9NwNH',
  },
})

webhook
  .on(WebhookEvent.ERROR, (err) =>
    console.log('Ansh webhook Error:', err.message)
  )
  .on(WebhookEvent.MESSAGE_SENT, (message) =>
    console.log('Ansh Message to chatbot:', message)
  )
...
app.post('/webhook', (req, res) => {
  ...
  if (body_param.object) {
    ...
    if (
      ...
      console.log(
        'Ansh your Message before sending to ODA is ------>' + message
      )
